...
public class Main {
    private static final String dirLocation = "src/books/";
    ...
    public static void main(String[] args)  {
        ...
        while (!exit) {
            ...
            List<String> top = statisticService.popularWorld(text, 3); // TODO: 07.05.2024  hardcoded var
            ...
            exit = !scanner.next().equals("n"); // TODO: 07.05.2024  hardcoded var
        }
        scanner.close();
    }
}